	...
	function initCanvas(canvas, config) {
		...
		if (renderHeight === null || renderHeight === '') {
			if (canvas.style.height === '') {
				...
				// (i.e. options.aspectRatio). If not specified, use canvas aspect ratio of 1 
				// which means 1:1. (Reference to Ln: 6845)
				canvas.height = canvas.width / (config.options.aspectRatio || 1);
			} else {
